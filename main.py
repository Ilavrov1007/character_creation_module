...
def attack(char_name: str, char_class: str) -> str:
    """"Функия для атаки противника всех классов."""
...
def defence(char_name: str, char_class: str) -> str:
    """"Функия для измерения защиты всех классов."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """"Функия для специального умения всех классов."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """"Стартовая функция для выбора класса."""
    approve_choice: str = ''
    char_class: str = ''
